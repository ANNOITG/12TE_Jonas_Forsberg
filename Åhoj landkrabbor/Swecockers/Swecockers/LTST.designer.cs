...
namespace Swecockers
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DropTheBase")]
    ...
    partial void DeleteRecord(Record instance);
		...
		public LTSTDataContext() : 
				base(global::Swecockers.Properties.Settings.Default.DropTheBaseConnectionString, mappingSource)
		{
			OnCreated();
		}
